...
* [**Support**](customer-center/rocket.chats-support-structure/): Our dedicated support structure is here to assist you every step of the way.
...
[Engage with other Rocket.Chat users](customer-center/rocket.chats-support-structure/community-resources.md), contribute to the conversation, and help shape the future of communication.
