...
{% hint style="info" %}
See a list of Releases, Mongo versions, and their deprecation notice here [#mongodb-versions](../../../resources/get-support/enterprise-support/#mongodb-versions "mention")
{% endhint %}
