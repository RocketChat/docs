...
{% hint style="warning" %}
Again, it is essential to note that we do not support direct docker/compose microservices deployment. The only supported method currently is using [Kubernetes with our official helm chart](../rapid-deployment-methods/helm.md).
{% endhint %}
...
{% hint style="info" %}
You can find other deployment variables in [helm.md](../rapid-deployment-methods/helm.md "mention").
{% endhint %}
...
{% hint style="info" %}
A complete guide on how to deploy with helm can be found in [helm.md](../rapid-deployment-methods/helm.md "mention"). For multi-workspace deployment, please [contact support](../../../resources/get-support/).
{% endhint %}
