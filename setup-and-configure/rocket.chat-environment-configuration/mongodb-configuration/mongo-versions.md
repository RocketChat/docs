...
{% hint style="info" %}
See a list of Releases, Mongo versions, and their deprecation notice here [#mongodb-versions](../../../customer-center/rocket.chats-support-structure/enterprise-support-and-version-durability.md#mongodb-versions "mention")
{% endhint %}
