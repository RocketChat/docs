...
See our [recommended deployment methods](broken-reference).
{% endhint %}
...
Then install mongodb on your system. Please see the [mongo section](broken-reference) in one of our guides for your current OS
...
Then follow the remainder of the guide on [setting up Rocket.Chat](broken-reference) for your current OS.
