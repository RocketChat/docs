...
| ------------------- | ----------------------------------------------------------------------- | -----------: | -----------: |
| 6.2                 | [6.2.10](https://github.com/RocketChat/Rocket.Chat/releases/tag/6.2.10) | Apr 2023     | TBD          |
...
| **4.8 \(LTS\)**     | [4.8.7](https://github.com/RocketChat/Rocket.Chat/releases/tag/4.8.7)   | **May 2022** | **Dec 2022** |
