...
* [Prepare for your Deployment](deploy/prepare-for-your-deployment/README.md)
  ...
  * [Rapid Deployment Methods](deploy/prepare-for-your-deployment/rapid-deployment-methods/README.md)
    * [Docker & Docker Compose](deploy/prepare-for-your-deployment/rapid-deployment-methods/docker-and-docker-compose/README.md)
      * [Available Images](deploy/prepare-for-your-deployment/rapid-deployment-methods/docker-and-docker-compose/docker-containers/available-images.md)
      * [Docker Mongo Backup and Restore](deploy/prepare-for-your-deployment/rapid-deployment-methods/docker-and-docker-compose/docker-containers/docker-mongo-backup-and-restore.md)
      * [Enable HTTPS](deploy/prepare-for-your-deployment/rapid-deployment-methods/docker-and-docker-compose/installing-nginx-and-ssl-certificate.md)
  ...
  * [Cloud Deployments](deploy/prepare-for-your-deployment/cloud-deployments/README.md)
    * [AWS](deploy/prepare-for-your-deployment/cloud-deployments/aws.md)
    * [Google Compute Engine](deploy/prepare-for-your-deployment/cloud-deployments/google-compute-engine.md)
    * [IBM Cloud](deploy/prepare-for-your-deployment/cloud-deployments/ibm-cloud.md)
    * [DigitalOcean](deploy/prepare-for-your-deployment/cloud-deployments/digitalocean.md)
  * [Other Deployment Methods](deploy/prepare-for-your-deployment/other-deployment-methods/README.md)
    * [Manual Installation](deploy/prepare-for-your-deployment/other-deployment-methods/manual-installation/README.md)
      * [Rocket.Chat in CentOS](deploy/prepare-for-your-deployment/other-deployment-methods/manual-installation/rocket.chat-in-centos.md)
      * [Debian Based Distros](deploy/prepare-for-your-deployment/other-deployment-methods/manual-installation/debian-based-distros/README.md)
        * [Rocket.Chat on Debian](deploy/prepare-for-your-deployment/other-deployment-methods/manual-installation/debian-based-distros/debian.md)
    ...
    * [Windows 10](deploy/prepare-for-your-deployment/other-deployment-methods/windows-10-pro.md)
...
* [Scaling Rocket.Chat](deploy/scaling-rocket.chat/README.md)
  * [Microservices](deploy/scaling-rocket.chat/microservices-setup.md)
  * [Running Multiple Instances](deploy/scaling-rocket.chat/running-multiple-instances.md)
  * [Automation Tools](deploy/scaling-rocket.chat/automation-tools/README.md)
    * [Ansible](deploy/scaling-rocket.chat/automation-tools/ansible.md)
    * [OpenShift](deploy/scaling-rocket.chat/automation-tools/openshift.md)
    * [Vagrant](deploy/scaling-rocket.chat/automation-tools/vagrant.md)
* [Installing Client Apps](deploy/installing-client-apps/README.md)
  * [Rocket.Chat Desktop & Mobile Apps](deploy/installing-client-apps/rocket.chat-desktop-and-mobile-apps.md)
  * [Minimum Requirements](deploy/installing-client-apps/minimum-requirements-for-using-rocket.chat.md)
* [Rocket.Chat Environment Configuration](deploy/rocket.chat-environment-configuration/README.md)
  * [Node Configuration](deploy/rocket.chat-environment-configuration/node-configuration/README.md)
    * [Supported NodeJs Version](deploy/rocket.chat-environment-configuration/node-configuration/supported-nodejs-version.md)
    * [Runtime Configuration](deploy/rocket.chat-environment-configuration/node-configuration/runtime-configuration.md)
  * [MongoDB Configuration](deploy/rocket.chat-environment-configuration/mongodb-configuration/README.md)
    * [MongoDB URI Authentication](deploy/rocket.chat-environment-configuration/mongodb-configuration/mongodb-uri-authentication.md)
    * [MongoDB Backup and Restore](deploy/rocket.chat-environment-configuration/mongodb-configuration/mongodb-backup-and-restore.md)
    * [Passing extra options to the Mongo driver](deploy/rocket.chat-environment-configuration/mongodb-configuration/mongo-options.md)
    * [Configure a replica set for MongoDB](deploy/rocket.chat-environment-configuration/mongodb-configuration/mongo-replicas.md)
    * [Migrating database from Meteor built in MongoDB](deploy/rocket.chat-environment-configuration/mongodb-configuration/migrating-meteor-mongo.md)
    * [MongoDB mmap to wiredTiger migration](deploy/rocket.chat-environment-configuration/mongodb-configuration/mongodb-mmap-to-wiredtiger-migration.md)
    * [Supported Mongo Versions](deploy/rocket.chat-environment-configuration/mongodb-configuration/mongo-versions.md)
  * [Firewall Configuration](deploy/rocket.chat-environment-configuration/optional-configurations.md)
