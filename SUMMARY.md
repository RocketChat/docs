...
* [Omnichannel](use-rocket.chat/omnichannel/README.md)
  * [Omnichannel Admin's Guide](use-rocket.chat/omnichannel/omnichannel-admins-guide/README.md)
    * [Queue Types (Routing Algorithm)](use-rocket.chat/omnichannel/omnichannel-admins-guide/queue-types-routing-algorithm.md)
  ...
  * [Reports](use-rocket.chat/omnichannel/omnichannel-reports.md)
...
* [Omnichannel Agent's Guides](use-rocket.chat/omnichannel-agents-guides/README.md)
  * [Omnichannel Conversations](use-rocket.chat/omnichannel-agents-guides/omnichannel-conversation.md)
...
* [Rocket.Chat Federation](use-rocket.chat/rocket.chat-federation.md)
  * [Matrix Bridge](use-rocket.chat/rocket.chat-federation/matrix-bridge/README.md)
    * [Matrix Admin Guide](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-admin-guide/README.md)
      * [Deploy a Federated Rocket.Chat Workspace](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-admin-guide/deploy-a-federated-rocket.chat-workspace.md)
      * [Federation Access Control](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-admin-guide/federation-access-control.md)
    ...
    * [Matrix User Guide](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-user-guide/README.md)
      * [Create federated rooms](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-user-guide/create-federated-rooms.md)
      * [Invite external users to your Rocket.Chat server](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-user-guide/invite-external-users-to-your-rocket.chat-server.md)
      * [Communicate with a federated user](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-user-guide/communicate-with-a-federated-user.md)
      * [Search and join public channels on the Matrix network](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-user-guide/search-and-join-public-channels-on-the-matrix-network.md)
      * [Assign roles for users in federated rooms](use-rocket.chat/rocket.chat-federation/matrix-bridge/matrix-user-guide/assign-roles-for-users-in-federated-rooms.md)
...
* [Rocket.Chat Marketplace](extend-rocket.chat-capabilities/rocket.chat-marketplace/README.md)
  * [Rocket.Chat Public Apps Guides](extend-rocket.chat-capabilities/rocket.chat-marketplace/rocket.chat-public-apps-guides/README.md)
    ...
    * [Bamboo App](extend-rocket.chat-capabilities/rocket.chat-marketplace/rocket.chat-public-apps-guides/bamboo-app.md)
...
* [Frequently Asked Questions](resources/frequently-asked-questions/README.md)
  ...
  * [Federation FAQs](resources/frequently-asked-questions/federation-faqs/README.md)
    * [Matrix Bridge FAQs](resources/frequently-asked-questions/federation-faqs/matrixbridge-faqs.md)
