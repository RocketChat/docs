...
* [User Manager](use-rocket.chat/user-manager/README.md)
  * [Custom Roles](use-rocket.chat/user-manager/custom-roles.md)
  * [Device Management](use-rocket.chat/user-manager/device-management/README.md)
    * [Device Management Settings](use-rocket.chat/user-manager/device-management/device-management-settings.md)
  * [Audit Messages](use-rocket.chat/user-manager/audit-messages/README.md)
    * [Additional Audit Results](use-rocket.chat/user-manager/audit-messages/additional-audit-results.md)
    * [Message Audit Logs](use-rocket.chat/user-manager/audit-messages/message-audit-logs.md)
